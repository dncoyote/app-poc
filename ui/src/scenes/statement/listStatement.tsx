...
const Statements: React.FC = () => {
  ...
  const columns: GridColDef[] = [
    ...
    },
    {
      ...
      headerName: "Amount",
      flex: 1,
      renderCell: (params) => `₹${params.value.toFixed(2)}`, // Append rupee symbol
      type: "number",
      headerAlign: "left",
      align: "left",
    },
  ...
  return (
    <Box m="20px">
      <Header title="STATEMENTS" subtitle="List of Statements" />
      ...
      >
        <DataGrid
          rows={statements}
          columns={columns}
          getRowId={(row) => row.id} // Use the correct field name with proper casing
          slots={{
            toolbar: GridToolbar,
          }}
        />
